...
- Use the [Titanic Teaching Lab](../labs/titanic_teaching_lab.qmd) for visible support cells and the [NSW + CPS Benchmark Lab](../labs/nsw_cps_benchmark_lab.qmd) for a benchmarked observational case.
