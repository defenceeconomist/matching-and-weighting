...
For a compact worked example built around visible support cells, see the [Titanic Teaching Lab](../labs/titanic_teaching_lab.qmd). For a benchmarked observational design closer to the NSW discussion in *The Mixtape*, see the [NSW + CPS Benchmark Lab](../labs/nsw_cps_benchmark_lab.qmd).
:::
