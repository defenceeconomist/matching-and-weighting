...
- The report anchors the observational estimates to the NSW experimental benchmark from `causaldata::nsw_mixtape` while estimating the adjustment methods on `MatchIt::lalonde`, which replaces the NSW controls with a PSID comparison sample.
